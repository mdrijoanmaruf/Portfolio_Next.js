    ...
    <footer className="bg-gradient-to-r from-black via-gray-900 to-black text-white py-8">
      <div className="container mx-auto max-w-6xl px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Rijoan</h3>
            <p className="text-gray-300">Building amazing web experiences with modern technologies.</p>
          </div>
          <div>
